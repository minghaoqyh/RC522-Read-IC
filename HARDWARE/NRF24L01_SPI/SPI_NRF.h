...
#define	MOSI      PAout(7)             // Master Out, Slave In pin (output)
#define	MISO      PAout(6)            // Master In, Slave Out pin (input)
#define	SCK       PAout(5)             // Serial Clock pin, (output)
#define	CSN       PCout(4)             // Slave Select pin, (output to CSN)
#define	CE        PAout(4)             // Chip Enable pin signal (output)
#define	IRQ       PAout(1)             // Interrupt signal, from nRF24L01 (input)
